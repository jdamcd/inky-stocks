...
You'll need a Raspberry Pi Zero 2 (or WH) with the [Pimoroni Inky pHAT](https://shop.pimoroni.com/products/inky-phat) installed. This project only supports the current 250x122 resolution version. Remember to [install the Inky library](https://learn.pimoroni.com/article/getting-started-with-inky-phat) on your Raspberry Pi first. 
